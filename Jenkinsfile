        ...
        stage('Building and Pushing Docker Image to GCR'){
            steps{
                ...
                script{
                    ...
                    gcloud auth activate-service-account --key-files=${GOOGLW_APPLICATION_CREDENTIALS}

                    gcloud config set project ${GCP_PROJECT}

                    gcloud auth configure-docker --quiet

                    docker build -t grc.io/${GCP_PROJECT}/ml-project:lastest .

                    docker push grc.io/${GCP_PROJECT}/ml-project:lastest
